...
void marker_prior_prob_constructor_test()
{
    Eigen::RowVectorXi marker(2);
    marker << 0, 1;

    {
        utl::MarkerPriorProb p(marker, 0);
    ...
    {
        utl::MarkerPriorProb p(marker, 1);
    ...
    {
        utl::MarkerPriorProb p(marker, 2);
...
void marker_prior_prob_marker01_test()
{
    Eigen::RowVectorXi marker(2);
    marker << 0, 1;

    {
        auto p = utl::MarkerPriorProb::Marker01(0);
    ...
    {
        auto p = utl::MarkerPriorProb::Marker01(1);
    ...
    {
        auto p = utl::MarkerPriorProb::Marker01(2);
...
void marker_prior_prob_test()
{
    marker_prior_prob_constructor_test();
    marker_prior_prob_marker01_test();
}
